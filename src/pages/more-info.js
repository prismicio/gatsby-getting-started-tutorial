  ...
  <Layout>
    ...
    <main className="container">
      <section className="full-width-image content-section">
        <Img fluid={data.sunThroughTrees.childImageSharp.fluid} alt="Sun through the trees" />
      </section>
      ...
      <section className="content-section text-section-1col">
        <p>
          ...
          arcu. Ut scelerisque hendrerit tellus. Integer sagittis. Vivamus a mauris eget arcu
          gravida tristique. Nunc iaculis mi in ante. Vivamus imperdiet nibh feugiat est.
        </p>
      </section>

      <section className="full-width-image content-section">
        <Img fluid={data.benchInForrest.childImageSharp.fluid} alt="Bench in the forrest" />
      </section>
      ...
      <section className="content-section text-section-2col">
        ...
        <p>
          ...
          vel, velit. Pellentesque egestas sem. Suspendisse commodo ullamcorper magna.
        </p>
      </section>
    </main>
  </Layout>
...
query {
  sunThroughTrees: file(relativePath: { eq: "sun-through-trees.jpg" }) {
    childImageSharp {
  ...
  benchInForrest: file(relativePath: { eq: "bench-in-forrest.jpg" }) {
    childImageSharp {
      fluid(maxWidth: 980, maxHeight: 300) {
        ...GatsbyImageSharpFluid
      }
